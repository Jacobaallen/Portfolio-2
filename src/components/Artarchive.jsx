          ...
          <div className="responsive">
            <div className="gallery">
              ...
              <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <h3>Tomoko and Ucchii on a date.</h3>
                    <p>2020</p>
                    <p>Pencil on paper</p>
                  </div>
                </div>
               ...
               <div className="flip-card">
                 <div className="flip-card-inner">
                   ...
                   <div className="flip-card-back">
                     ...
                     <p>2019</p>
                    <p>1/2 inch foam board, Paint, Cardboard, metal cane</p>
                  </div>
                </div>
              </div>
            </div>
             ...
             <div className="responsive">
               <div className="gallery">
                 <div className="flip-card">
                   <div className="flip-card-inner">
                     <div className="flip-card-front">
                       <img src="images/drawing-10-2018.png" alt="draw" width=  "450" height= "600"/>
                     </div>
                     <div className="flip-card-back">
           ...
           <div className="responsive">
             <div className="gallery">
               <div className="flip-card">
                 <div className="flip-card-inner">
                   <div className="flip-card-front">
                     <img src="images/art-color-fall-2.jpg" alt="art" width=  "400" height= "600"/>
                   </div>
                   <div className="flip-card-back">
                     <h3>Color Fall 2</h3>
                     <p>2015</p>
           ...
           <div className="responsive">
             <div className="gallery">
               <div className="flip-card">
                 <div className="flip-card-inner">
                   <div className="flip-card-front">
                     <img src="images/art-evening-sunset-2015.jpg" alt="art" width=  "500" height= "300"/>
                   </div>
                   <div className="flip-card-back">
           ...
           <div className="responsive">
             <div className="gallery">
               <div className="flip-card">
                 <div className="flip-card-inner">
                   <div className="flip-card-front">
                     <img src="images/clay-ancient-arifact-2014.jpg" alt="clay" width=  "400" height= "600"/>
                   </div>
                   <div className="flip-card-back">
